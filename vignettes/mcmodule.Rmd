...
*The following section is based primarily on the [mc2d](https://CRAN.R-project.org/package=mc2d) package vignette, adapted and expanded specifically for the context of modular, flexible Monte Carlo simulations.*
