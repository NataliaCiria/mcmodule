...
The scenario id, group id, and row number are the three mcnode properties that enable row matching and row aggregation operations (see @sec-row-matching).
...
![Default row aggregation and row aggregation keeping all variates](images/mcmodule_keep_variates.png){fig-align="center" width="80%"}
