...
Once scenario totals are available, we can directly compare each what-if scenario
against baseline using `mc_compare()`. Here we compute the **relative risk
reduction** in `no_detect_set_agg` for each pathogen:
